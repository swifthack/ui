...
const CustomerManagementPage = ({ onSaveCustomer, onDeleteCustomer, onUpdateCustomerWallets }) => {
  ...
  return (
    <div className="p-6">
      ...
      <h4 className="font-extrabold text-gray-800 mb-6">Note: Customers who created DEX profile will only be registered here. Email is validated for customer registration</h4>
